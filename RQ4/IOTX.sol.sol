...
library SafeMath {
  ...
  */
  ...
  /* CertiK Smart Labelling, for more details visit: https://certik.org */
  /// ensures(true, c == a - b)
  function sub(uint256 a, uint256 b) internal pure returns (uint256 c) {(bool __v1, bool __v2)=(true,  c == a - b);require(a >= 0);require(b >= 0);
    assert(b <= a);
    return a - b;
  }
...
contract Pausable is Ownable {bool old_paused;
   ...
   */
  /// ensures(true, paused)
  function pause() onlyOwner whenNotPaused public {(bool __v1, bool __v2)=(true,  paused);
    paused = true;
    emit Pause();
  }
   ...
   */
  /// ensures(true, !paused)
  function unpause() onlyOwner whenPaused public {(bool __v1, bool __v2)=(true,  !paused);
    paused = false;
    emit Unpause();
  }
}
 ...
 */
contract BasicToken is ERC20Basic {mapping(address => uint256) old_balances;uint256 old_totalSupply_;
...
contract StandardToken is ERC20, BasicToken {mapping(address => mapping(address => uint256)) old_allowed;
  ...
  function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {(bool __v1, bool __v2)=(true,  balances[_from] == old_balances[_from] - _value && balances[_to] == old_balances[_to] + _value && allowed[_from][msg.sender] == old_allowed[_from][msg.sender] - _value);require(_value >= 0);
    require(_to != address(0));
...
contract IoTeXNetwork is StandardToken, Pausable {string old_name;string old_symbol;uint8 old_decimals;
    ...
    function transfer(address _to, uint _value) whenNotPaused
        ...
        returns (bool) {(bool __v1, bool __v2)=(true,  true);require(_value >= 0);
    ...
    function increaseApproval(address _spender, uint _addedValue) public whenNotPaused
      returns (bool success) {(bool __v1, bool __v2)=(true,  true);require(_addedValue >= 0);
    ...
    function decreaseApproval(address _spender, uint _subtractedValue) public whenNotPaused
      returns (bool success) {(bool __v1, bool __v2)=(true,  true);require(_subtractedValue >= 0);
