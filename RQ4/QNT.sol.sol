 ...
 */
contract StandardToken is ERC20, BasicToken {string old_name;string old_symbol;uint8 old_decimals;uint256 old_DECIMAL_ZEROS;mapping(address => mapping(address => uint256)) old_allowed;address old_crowdsale;
  ...
  /// ensures(true, crowdsale == _crowdsale)
  function StandardToken(address _crowdsale) public {(bool __v1, bool __v2)=(true,  crowdsale == _crowdsale);
    require(_crowdsale != address(0));
    crowdsale = _crowdsale;
  }
  /// ensures(true, balances[_address] == old(balances[_address]) + _value)
  function mint(address _address, uint256 _value) public onlyCrowdsale {(bool __v1, bool __v2)=(true,  balances[_address] == old_balances[_address] + _value);require(_value >= 0);
