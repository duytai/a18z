...
contract RegularToken is Token {mapping(address => uint256) old_balances;mapping(address => mapping(address => uint256)) old_allowed;uint256 old_totalSupply;
    ...
    function transfer(address _to, uint _value) returns (bool) {(bool __v1, bool __v2)=(true,  balances[msg.sender] == old_balances[msg.sender] - _value && balances[_to] == old_balances[_to] + _value);require(_value >= 0);
    ...
    function transferFrom(address _from, address _to, uint _value) returns (bool) {(bool __v1, bool __v2)=(true,  balances[_from] == old_balances[_from] - _value && balances[_to] == old_balances[_to] + _value && allowed[_from][msg.sender] == old_allowed[_from][msg.sender] - _value);require(_value >= 0);
...
contract UnboundedRegularToken is RegularToken {uint256 old_MAX_UINT;
    ...
    function transferFrom(address _from, address _to, uint _value)
        public
        returns (bool)
    {(bool __v1, bool __v2)=(true,  balances[_from] == old_balances[_from] - _value && balances[_to] == old_balances[_to] + _value && allowed[_from][msg.sender] == old_allowed[_from][msg.sender] - _value);require(_value >= 0);require(MAX_UINT >= 0);
