...
contract GVToken is StandardToken {string old_name;string old_symbol;uint256 old_decimals;uint256 old_TOKEN_LIMIT;address old_ico;bool old_isFrozen;address old_migrationMaster;address old_migrationAgent;uint256 old_totalMigrated;
    ...
    // Constructor
    function GVToken(address _ico, address _migrationMaster) {(bool __v1, bool __v2)=(1==1, 1==0);
        require(_ico != 0);
    ...
    // Create tokens
    function mint(address holder, uint value) {(bool __v1, bool __v2)=(1==1, 1==0);require(value >= 0);require(TOKEN_LIMIT >= 0);require(totalSupply >= 0);
    ...
    function unfreeze() {(bool __v1, bool __v2)=(1==1, 1==0);
        require(msg.sender == ico);
        isFrozen = false;
    }
    ...
    function transfer(address _to, uint _value) public returns (bool) {(bool __v1, bool __v2)=(1==1, 1==0);require(_value >= 0);
        require(_to != address(0));
        require(!isFrozen);
        return super.transfer(_to, _value);
    }

    function transferFrom(address _from, address _to, uint _value) public returns (bool) {(bool __v1, bool __v2)=(1==1, 1==0);require(_value >= 0);
        require(!isFrozen);
        return super.transferFrom(_from, _to, _value);
    }

    function approve(address _spender, uint _value) public returns (bool) {(bool __v1, bool __v2)=(1==1, 1==0);require(_value >= 0);
        require(!isFrozen);
        return super.approve(_spender, _value);
    }

    // Token migration
    function migrate(uint value) external {(bool __v1, bool __v2)=(1==1, 1==0);require(value >= 0);require(totalMigrated >= 0);require(totalSupply >= 0);
        ...
        totalSupply = totalSupply - value;
        totalMigrated = totalMigrated + value;
        address agent = migrationAgent;
        MigrationAgent(agent).migrateFrom(msg.sender, value);
        Migrate(msg.sender, agent, value);
    }

    // Set address of migration contract
    function setMigrationAgent(address _agent) external {(bool __v1, bool __v2)=(1==1, 1==0);
        require(migrationAgent == 0);
        require(msg.sender == migrationMaster);
        migrationAgent = _agent;
    }

    function setMigrationMaster(address _master) external {(bool __v1, bool __v2)=(1==1, 1==0);
        require(msg.sender == migrationMaster);
        require(_master != 0);
...
contract GVOptionToken is StandardToken {address old_optionProgram;string old_name;string old_symbol;uint256 old_decimals;uint256 old_TOKEN_LIMIT;
    ...
    function GVOptionToken(
        ...
        string _symbol,
        uint _TOKEN_LIMIT
    ) {(bool __v1, bool __v2)=(1==1, 1==0);require(_TOKEN_LIMIT >= 0);
    ...
    // Create tokens
    function buyOptions(address buyer, uint value) optionProgramOnly {(bool __v1, bool __v2)=(1==1, 1==0);require(value >= 0);require(TOKEN_LIMIT >= 0);require(totalSupply >= 0);
        require(value > 0);
        require(totalSupply + value <= TOKEN_LIMIT);
    ...
    function remainingTokensCount() returns(uint) {(bool __v1, bool __v2)=(1==1, 1==0);require(TOKEN_LIMIT >= 0);require(totalSupply >= 0);
    ...
    function executeOption(address addr, uint optionsCount) 
        optionProgramOnly
        returns (uint) {(bool __v1, bool __v2)=(1==1, 1==0);require(optionsCount >= 0);require(totalSupply >= 0);
...
contract GVOptionToken0 is GVOptionToken{
    function GVOptionToken0(
        address _optionProgram,
        string _name,
        string _symbol,
        uint _TOKEN_LIMIT) 
        GVOptionToken( _optionProgram, _name, _symbol, _TOKEN_LIMIT) {(bool __v1, bool __v2)=(1==1, 1==0);require(_TOKEN_LIMIT >= 0);
        }
}

contract GVOptionToken1 is GVOptionToken{
    function GVOptionToken1(
        address _optionProgram,
        string _name,
        string _symbol,
        uint _TOKEN_LIMIT) 
...
contract GVOptionProgram {uint256 old_option30perCent;uint256 old_option20perCent;uint256 old_option10perCent;uint256 old_token30perCent;uint256 old_token20perCent;uint256 old_token10perCent;string old_option30name;string old_option20name;string old_option10name;string old_option30symbol;string old_option20symbol;string old_option10symbol;uint256 old_option30_TOKEN_LIMIT;uint256 old_option20_TOKEN_LIMIT;uint256 old_option10_TOKEN_LIMIT;address old_gvAgent;address old_team;address old_ico;GVOptionToken0 old_gvOptionToken30;GVOptionToken1 old_gvOptionToken20;GVOptionToken2 old_gvOptionToken10;
    ...
    // Constructor
    function GVOptionProgram(address _ico, address _gvAgent, address _team) {(bool __v1, bool __v2)=(1==1, 1==0);require(option10_TOKEN_LIMIT >= 0);require(option20_TOKEN_LIMIT >= 0);require(option30_TOKEN_LIMIT >= 0);
        ///
        gvOptionToken30 = new GVOptionToken0(this, option30name, option30symbol, option30_TOKEN_LIMIT);
        gvOptionToken20 = new GVOptionToken1(this, option20name, option20symbol, option20_TOKEN_LIMIT);
        gvOptionToken10 = new GVOptionToken2(this, option10name, option10symbol, option10_TOKEN_LIMIT);
        gvAgent = _gvAgent;
        team = _team;
        ico = _ico;
    }
    ...
    function getBalance() public returns (uint, uint, uint) {(bool __v1, bool __v2)=(1==1, 1==0);
    ...
    function executeOptions(address buyer, uint usdCents, string txHash) icoOnly
        returns (uint executedTokens, uint remainingCents) {(bool __v1, bool __v2)=(1==1, 1==0);require(usdCents >= 0);require(token30perCent >= 0);
        require(usdCents > 0);
    ...
    function executeIfAvailable(address buyer, uint usdCents, string txHash,
        ...
        private returns (uint executedTokens, uint remainingCents) {(bool __v1, bool __v2)=(1==1, 1==0);require(usdCents >= 0);require(optionType >= 0);require(optionPerCent >= 0);
...
// contract Deployer{
//    address a = 0xDEADBEEF1;
//    address b = 0xDEADBEEF2;
//    address c = 0xDEADBEEF3;
//     function Deployer() {
//         ICO ico = new ICO(this, a, b, c);
